...
{
	public abstract class ImGuiManagerBase<TContext> : MonoBehaviour
	{
		[SerializeField]
		...
		[SerializeField]
		private ImGuiMenuBarBase<TContext> _imGuiMenuBar;

		[SerializeField]
		private List<ImGuiWindowBase<TContext>> _otherWindowsList;
